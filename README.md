...
Version `0.1.0` is the minimum end-to-end deployment baseline. It is designed for live Fabric validation and iterative correction of item definitions, Direct Lake binding, and report visuals.
